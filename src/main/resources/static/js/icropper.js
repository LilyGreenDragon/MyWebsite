...
(function(){
    ...
    ICropper.prototype = {
        ...
        //The image url
        //image: '/images/imagecab/3.png'
        image: 'util.byId(hiddenField).value'
        ...
        ,setImage: function() {
            ...
            var url=util.byId(hiddenField).value;
            //console.log(url);
            //var url="";
            if (url=="") {url="/images/1.gif"}
            var img = new Image();
        ...
        ,bindPreview: function(node){
            ...
            previewImage.id="idPreviewImage"
            ...
            this.onChange = function(info){
                ...
                console.log(info.ch);
                        ...
                        util.byId(x).setAttribute("value", info.l);
                        util.byId(y).setAttribute("value", info.t);
                        util.byId(w).setAttribute("value", info.w);
                        util.byId(h).setAttribute("value", info.h);
                        util.byId(widthImage).setAttribute("value", info.cw);
        ...
        ,getInfo: function() {
            ...
            return {
                w: this.cropNode.offsetWidth - 2    //2 is hard code border width область обрезки
                ,h: this.cropNode.offsetHeight - 2 //область обрезки
                ,l: parseInt(util.style(this.cropNode, 'left'))
                ,t: parseInt(util.style(this.cropNode, 'top'))
                ,cw: this.domNode.offsetWidth //container width картинка
                ,ch: this.domNode.offsetHeight //container height картинка
            };
