...
public class AuthController {
    ...
    @Autowired
    public AuthController(AuthenticationManager authenticationManager, RegistrationService registrationService, PersonValidator personValidator, PeopleRepository peopleRepository, SessionRegistry sessionRegistry) {
