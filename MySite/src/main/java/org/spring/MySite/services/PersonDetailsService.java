...
public class PersonDetailsService implements UserDetailsService {
    ...
    @Autowired
    public PersonDetailsService(PeopleRepository peopleRepository, LoginAttemptService loginAttemptService) {
   ...
   @Override
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
       System.out.println("IP клиента: " + loginAttemptService.getClientIP());
        ...
        //Вариант 1
        /*Person person =  peopleRepository.findByUsername(username).orElseThrow(() ->new UsernameNotFoundException("User not found"));
